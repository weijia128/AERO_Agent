...
const defaultFsmStates: DisplayState[] = [
  ...
  { id: 'P3_IMPACT_ANALYSIS', label: '影响分析', short: 'P3' },
  { id: 'P4_NOTIFICATION', label: '通知', short: 'P4' },
  { id: 'P5_MONITORING', label: '监控', short: 'P5' },
  { id: 'P6_FOLLOWUP', label: '后续处理', short: 'P6' },
  { id: 'P7_REPORTING', label: '报告', short: 'P7' },
...
const stateMapping: Record<string, string> = {
  ...
  'P3_IMPACT': 'P3_IMPACT_ANALYSIS',
  'P4_NOTIFY': 'P4_NOTIFICATION',
  'P5_MONITOR': 'P5_MONITORING',
  'P6_FOLLOW': 'P6_FOLLOWUP',
  'P7_REPORT': 'P7_REPORTING',
  'P8_CLOSE': 'P8_CLOSE',
  // 下划线变体
  'RISK_ASSESS': 'P1_RISK_ASSESS',
  'IMMEDIATE_CONTROL': 'P2_IMMEDIATE_CONTROL',
  'IMPACT_ANALYSIS': 'P3_IMPACT_ANALYSIS',
  'NOTIFICATION': 'P4_NOTIFICATION',
  'MONITORING': 'P5_MONITORING',
  'FOLLOWUP': 'P6_FOLLOWUP',
  'REPORTING': 'P7_REPORTING',
  'CLOSE': 'P8_CLOSE',
  'COMPLETE': 'COMPLETED',
};
